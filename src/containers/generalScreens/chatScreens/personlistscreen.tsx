...
import { myData, personData } from '@/utils/data';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{ marginHorizontal: 16 }}>
        ...
        <View style={[styles.searchbar,{ marginTop: 24, alignItems: "center" }]}>
          ...
          />
            <Octicons 
              ...
              color={theme.black} 
            />
          {/* <Image style={styles.searchimg} source={require('@/assets/images/patient.png')} /> */}
