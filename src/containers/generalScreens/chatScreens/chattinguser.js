...
import styles1 from '@/assets/styles/chatStyle'
import ImagePicker from 'react-native-image-crop-picker';
import DocumentPicker, { types } from 'react-native-document-picker';
import { Link, useNavigation } from '@react-navigation/native'
import { chatsData } from '@/utils/data/data';
...
const Chattinguser = ({ ...props }) => {
  ...
  useEffect(() => {
    ...
    if (coord !== null) {
      ...
      let addmsg = [...msgdata, {
        ...
        time: '10:50 PM',
        msg: coord,
        userImage: require('@/assets/images/chateimage/map.png')
      }]
  ...
  // // let perm = [ PERMISSIONS.IOS.LOCATION_WHEN_IN_USE, PERMISSIONS.IOS.LOCATION_ALWAYS ];
  // // let result = await requestMultiple(perm);
  ...
  //             {
  //               text: "Cancel", onPress: () => {
  //                 console.log("user press on cancel");
  //               }
  //             },
  //             {
  //               text: "Yes", onPress: () => {
      ...
      <>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Userpayment')}>
          <View style={styles.joboffer}>
            <Image style={styles.cupimg} source={require('@/assets/images/chateimage/cup.png')} />
  ...
  const Sendmsg = () => {
    ...
    let addmsg = [...msgdata, {
      ...
      time: '10:50 PM',
      msg: text,
      userImage: require('@/assets/images/chateimage/chat10.png')
    }]
    settext('')
    setsetmsgdata(addmsg)
  ...
  console.log("MymsgIasasdjkhaskjdhaskjd=====>",selecteddata);
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#fff" }} >
      ...
      {/* <SafeAreaView style={{ flex: 1 }}  >
            ...
            <View style={styles1.inputContainerBottom}>
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: "center", width: 110 }}>
                <Pressable onPress={() => { onPressLoc() }}>
                  <Image source={require('@/assets/images/chat/location.png')} style={{ width: 20, height: 20, resizeMode: "contain" }} />
                </Pressable>
                <Pressable onPress={() => { onPressClip() }} >
                  <Image source={require('@/assets/images/chat/paper-clip.png')} style={{ width: 17, height: 18, resizeMode: "contain" }} />
                </Pressable>
                <Pressable onPress={() => { Sendmsg() }} disabled={!text} style={{ borderRadius: 16, justifyContent: "center", alignItems: "center", width: 32, height: 32, backgroundColor: '#0760F0', marginVertical: 13 }}>
                  <Image source={require('@/assets/images/chat/send.png')} style={{ width: 13, height: 13, tintColor: "#fff", resizeMode: 'contain' }} />
                </Pressable>
              </View>
            </View>
          </View>
        ...
        >
          <View style={{ flex: 1 }}>
            ...
            <TouchableOpacity onPress={() => { chooseImage() }} style={{ alignItems: 'center', justifyContent: "center", height: 50 }}>
              <View>
                <Text style={{ fontSize: 16, color: '#2483df' }}>Choose a Image/Videos</Text>
              </View>
            </TouchableOpacity>
          ...
          >
            {BottomButton("Reply", require("@/assets/images/chatScreens/reply.png"), senderReply )}
            {BottomButton("Copy", require("@/assets/images/chatScreens/copy.png"), sendercopyToClipboard)}
            {BottomButton("Report", require("@/assets/images/chatScreens/report.png"), senderReport )}
          </RBSheet>
        ...
        >
        {BottomButton("Quote", require("@/assets/images/chatScreens/quote.png"), myMsgQuote )}
        {BottomButton("Copy", require("@/assets/images/chatScreens/copy.png"), myMsgcopyToClipboard )}
        {BottomButton("Delete", require("@/assets/images/chatScreens/delete.png"), myMsgdelete)}
        </RBSheet>
