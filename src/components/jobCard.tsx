  ...
  return (
    <View key={id} style={[styles.cardContainer, { marginTop: marginTop }]}>
       ...
       renderItem={({item})=>{   
        ...
        if (item?.applianceCount>0) {   
          ...
          <View style={styles.cardFourthLineLeft}>
            <Text style={styles.widthTextAppL}>( {item.applianceCount} ) {item.applianceName}:</Text>
            <Text style={styles.widthTextL}>{item.totalwattofthisAppliance} watt</Text>
          </View>
        )
      }
       }}
     />
      ...
      <View style={styles.cardFourthLineLeft}>
          <Text style={styles.widthTextAppL}>Fan:</Text>
          <Text style={styles.widthTextL}>{List.fan} watt</Text>
      </View>
      <View style={styles.cardFourthLineRight}>
          <Text style={styles.widthTextAppR}>Light:</Text>
          <Text style={styles.widthTextR}>{List.light} watt</Text>
      </View>
      </View>
    */}
